...
describe('Component Tests', () => {
  describe('Thuephong Management Component', () => {
    let comp: ThuephongComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ThuephongComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.thuephongs?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
