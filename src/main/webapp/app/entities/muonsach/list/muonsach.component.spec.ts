...
describe('Component Tests', () => {
  describe('Muonsach Management Component', () => {
    let comp: MuonsachComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MuonsachComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.muonsaches?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
